namespace ZetaHtmlEditControl
{
        ...
        IDisposable
    {
        ...
        private const int IdmPrint = 27;
        private const int IdmPrintpreview = 2003;
        ...
        #endregion PrepareDocumentTextSet + BuildCompleteHtml + ReplaceCss
        ...
        #endregion PrepareDocumentTextGet
        ...
        #endregion GetOnlyTextFromHtmlCode + RemoveHtmlChars + RemoveTagFromHtmlCode
        ...
        */
        ...
        #endregion HandlePaste [CheckImages-GetSourceURLFromClipboardH...-GetHtmlFragmentFromC...]
        ...
        */
        ...
        #endregion SelectionType (Control, Text, None)
        ...
        public int FontSize
        {
            get
            {
                object value = DomDocument.queryCommandValue(@"FontSize");
        ...
        public void ExecutePrintPreview()
        {
            if (Document != null && Configuration.AllowPrint)
                OleCommandTargetExecute(IdmPrintpreview, null);
        }

        public void ExecutePrint()
        {
            if (Document != null && Configuration.AllowPrint)
                OleCommandTargetExecute(IdmPrint, null);
        }
        ...
        #endregion Helpers for HTML extraction.
        ...
        #endregion Comparison of IMarkupPointer interfaces.
        ...
        #endregion IDocHostUIHandler members.
